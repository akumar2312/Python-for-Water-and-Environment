"""
Program to solve advection, diffusion, reaction
equations for modelling the contaminant
transport problem. Given the location
and strength (concentration) of the
source function, we study the spread
concentration of the reactant as a function
of space and time. To make the visualizations
appealing we load the velocity data from the
